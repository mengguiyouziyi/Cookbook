...
SPIDER_MODULES = ['cookbook.spiders']
NEWSPIDER_MODULE = 'cookbook.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    # 'cookbook.middlewares.ProxyMiddleware': 1,
    # 'cookbook.middlewares.RetryMiddleware': 110,
    'cookbook.middlewares.RotateUserAgentMiddleware': 3,
    # 'cookbook.middlewares.BloomfilterMiddleware': 2,
